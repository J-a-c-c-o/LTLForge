...
impl GNBA {
    pub fn construct(ltl: &LTL) -> Self {
        ...
        let acceptance_conditions = generate_acceptance_conditions(&states, &closure);
        GNBA {
            closure,
            states,
            initial_states,
...
mod tests {
    ...
    fn test_GNBA_construction() {
        ...
        let gnba = GNBA::construct(&formula);
